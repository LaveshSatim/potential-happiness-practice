package com.bfpp.beanfactorypostprocessor;
...
public class BFPPTest {
	public static void main(String[] args) {
		 ...
		 */
		ApplicationContext context = new ClassPathXmlApplicationContext("com/bfpp/beanfactorypostprocessor/application-context.xml");
